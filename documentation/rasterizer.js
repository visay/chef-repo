...
resource = {
	...
	url:'http://ci.web-essentials.asia/job/BLT-cs2_bltemployee/',

	// Where the bullet 1,2,3,... will appear
	selectors:[
		'#tasks .task:nth-child(8)',
		'#tasks .task:nth-child(9)',
		'#tasks .task:nth-child(11)',
		'#tasks .task:nth-child(12)',
		'#tasks .task:nth-child(13)'
	]
}
resources.push(resource);

var jqueryResource = 'http://localhost/jquery.min.js';
